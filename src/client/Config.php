...
class Config
{
    ...
    // custody provided public key
    private $custodyPublicKey = "" ;
     ...
     * @return string
     */
    public function getCustodyPublicKey()
    {
        return $this->custodyPublicKey;
    }

    /**
     * @param string $custodyPublicKey
     */
    public function setCustodyPublicKey($custodyPublicKey)
    {
